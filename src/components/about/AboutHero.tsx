  ...
  return (
    ...
    >
      <div className="absolute inset-0 z-0">
        <Image
          src="/img/bg/about-bg.jpg"
          alt="About TwentyPercent Designs"
          fill
          priority
          loading="eager"
          sizes="100vw"
      ...
      <div className="legacy-container relative z-10 min-h-[450px] md:min-h-[480px] flex items-center justify-center">
        ...
        <div className="w-full">
          <div className="flex flex-col items-center justify-center py-12 md:py-0">
            ...
            >
              <span className="eyebrow block mb-[10px]">Advertising Experts in Mumbai</span>
              Most Effective. <br className="hidden md:block" />
